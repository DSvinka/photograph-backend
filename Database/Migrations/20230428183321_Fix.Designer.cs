            ...
            modelBuilder.Entity("Domain.Models.Albums.AlbumFileRelation", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        ...
                        .HasDefaultValue(new DateTime(2023, 4, 28, 18, 33, 21, 565, DateTimeKind.Utc).AddTicks(6861))
                    ...
                    b.Property<DateTime>("LastUpdated")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 4, 28, 18, 33, 21, 565, DateTimeKind.Utc).AddTicks(6473))
            ...
            modelBuilder.Entity("Domain.Models.Albums.AlbumModel", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 4, 28, 18, 33, 21, 565, DateTimeKind.Utc).AddTicks(3051))
                        .HasColumnName("created");
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 4, 28, 18, 33, 21, 565, DateTimeKind.Utc).AddTicks(2734))
                        .HasColumnName("last_updated");
            ...
            modelBuilder.Entity("Domain.Models.FileModel", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 4, 28, 18, 33, 21, 564, DateTimeKind.Utc).AddTicks(8726))
                        .HasColumnName("created");
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 4, 28, 18, 33, 21, 564, DateTimeKind.Utc).AddTicks(8439))
                        .HasColumnName("last_updated");
            ...
            modelBuilder.Entity("Domain.Models.SettingsModel", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 4, 28, 18, 33, 21, 564, DateTimeKind.Utc).AddTicks(9585))
                        .HasColumnName("created");
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 4, 28, 18, 33, 21, 564, DateTimeKind.Utc).AddTicks(9345))
                        .HasColumnName("last_updated");
            ...
            modelBuilder.Entity("Domain.Models.StringModel", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 4, 28, 18, 33, 21, 565, DateTimeKind.Utc).AddTicks(1063))
                        .HasColumnName("created");

                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 4, 28, 18, 33, 21, 565, DateTimeKind.Utc).AddTicks(801))
                        .HasColumnName("last_updated");
            ...
            modelBuilder.Entity("Domain.Models.UserModel", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 4, 28, 18, 33, 21, 564, DateTimeKind.Utc).AddTicks(7602))
                        .HasColumnName("created");

                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 4, 28, 18, 33, 21, 564, DateTimeKind.Utc).AddTicks(7275))
                        .HasColumnName("last_updated");
