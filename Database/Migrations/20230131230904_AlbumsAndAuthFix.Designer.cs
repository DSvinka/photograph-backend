...
namespace Database.Migrations
{
    ...
    [Migration("20230131230904_AlbumsAndAuthFix")]
    partial class AlbumsAndAuthFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.Albums.AlbumFileRelation", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        ...
                        .HasDefaultValue(new DateTime(2023, 1, 31, 23, 9, 4, 479, DateTimeKind.Utc).AddTicks(9297))
                    ...
                    b.Property<DateTime>("LastUpdated")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 1, 31, 23, 9, 4, 479, DateTimeKind.Utc).AddTicks(8958))
            ...
            modelBuilder.Entity("Domain.Models.Albums.AlbumModel", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 1, 31, 23, 9, 4, 479, DateTimeKind.Utc).AddTicks(5237))
                        .HasColumnName("created");
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 1, 31, 23, 9, 4, 479, DateTimeKind.Utc).AddTicks(4908))
                        .HasColumnName("last_updated");
            ...
            modelBuilder.Entity("Domain.Models.FileModel", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 1, 31, 23, 9, 4, 479, DateTimeKind.Utc).AddTicks(1184))
                        .HasColumnName("created");
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 1, 31, 23, 9, 4, 479, DateTimeKind.Utc).AddTicks(780))
                        .HasColumnName("last_updated");
            ...
            modelBuilder.Entity("Domain.Models.SettingsModel", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 1, 31, 23, 9, 4, 479, DateTimeKind.Utc).AddTicks(2942))
                        .HasColumnName("created");
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 1, 31, 23, 9, 4, 479, DateTimeKind.Utc).AddTicks(2667))
                        .HasColumnName("last_updated");
            ...
            modelBuilder.Entity("Domain.Models.UserModel", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 1, 31, 23, 9, 4, 478, DateTimeKind.Utc).AddTicks(9610))
                        .HasColumnName("created");

                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 1, 31, 23, 9, 4, 478, DateTimeKind.Utc).AddTicks(9147))
                        .HasColumnName("last_updated");
