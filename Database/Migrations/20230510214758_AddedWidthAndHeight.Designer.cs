...
namespace Database.Migrations
{
    ...
    [Migration("20230510214758_AddedWidthAndHeight")]
    partial class AddedWidthAndHeight
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.Albums.AlbumFileRelation", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        ...
                        .HasDefaultValue(new DateTime(2023, 5, 10, 21, 47, 58, 422, DateTimeKind.Utc).AddTicks(1046))
                    ...
                    b.Property<DateTime>("LastUpdated")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 21, 47, 58, 422, DateTimeKind.Utc).AddTicks(761))
            ...
            modelBuilder.Entity("Domain.Models.Albums.AlbumModel", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 21, 47, 58, 421, DateTimeKind.Utc).AddTicks(7722))
                        .HasColumnName("created");
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 21, 47, 58, 421, DateTimeKind.Utc).AddTicks(7413))
                        .HasColumnName("last_updated");
            ...
            modelBuilder.Entity("Domain.Models.FileModel", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 21, 47, 58, 421, DateTimeKind.Utc).AddTicks(4028))
                        .HasColumnName("created");
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 21, 47, 58, 421, DateTimeKind.Utc).AddTicks(3823))
                        .HasColumnName("last_updated");
            ...
            modelBuilder.Entity("Domain.Models.SettingsModel", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 21, 47, 58, 421, DateTimeKind.Utc).AddTicks(4751))
                        .HasColumnName("created");
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 21, 47, 58, 421, DateTimeKind.Utc).AddTicks(4550))
                        .HasColumnName("last_updated");
            ...
            modelBuilder.Entity("Domain.Models.StringModel", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 21, 47, 58, 421, DateTimeKind.Utc).AddTicks(6048))
                        .HasColumnName("created");

                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 21, 47, 58, 421, DateTimeKind.Utc).AddTicks(5805))
                        .HasColumnName("last_updated");
            ...
            modelBuilder.Entity("Domain.Models.UserModel", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 21, 47, 58, 421, DateTimeKind.Utc).AddTicks(3090))
                        .HasColumnName("created");

                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 21, 47, 58, 421, DateTimeKind.Utc).AddTicks(2841))
                        .HasColumnName("last_updated");
